...
import { CartProduct, CreateOrder, OrderFormInputValidation } from '@/types/order.types';
...
const CheckoutModal = ({ 
    ...
    useEffect(() => {
      if(token && userId !== 0 && productList.length !== 0 && totalAmount !== 0) {
        setFormData({
            ...formData,
            user_rid: userId,
        ...
        try {
            ...
            if(Object.keys(newErrors).length === 0) {
                ...
                if (response.status === 201) {
                    ...
                    resetForm();
                    setOpenCheckoutModal(!openCheckoutModal);
                    // error popup for error while add order
                    Swal.fire({
                        title: "Ooops..!",
                ...
                <div className="flex flex-col p-5 rounded-lg shadow bg-white">
                    ...
                    <div className="flex justify-end items-center mt-3">
                        <button 
                            ...
                            onClick={() => setOpenCheckoutModal(!openCheckoutModal)}
                        >
                            Cancel
                        </button>
                        <button 
